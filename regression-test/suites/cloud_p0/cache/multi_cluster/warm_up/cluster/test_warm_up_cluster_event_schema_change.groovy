...
suite('test_warm_up_cluster_event_schema_change', 'docker') {
    ...
    def run_schema_change = {
        ...
        sql """select v['k1'] from ${table_name} order by k limit 10"""
        sql "alter table ${table_name} add column vs string default null"
        sql """INSERT INTO ${table_name} SELECT k, v, v from ${table_name}"""
        sql """select v['k1'] from ${table_name} order by k desc limit 10"""
