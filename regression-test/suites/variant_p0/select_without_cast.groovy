...
suite("regression_test_select_variant_without_cast", "variant_type_select"){
    ...
    try {
        ...
        Thread.sleep(12000)
        qt_sql_2 """select v:c.c from ${table_name} order by k"""
        ...
        // todo: fix predicate column type is string
        // qt_sql_2_10 """select * from ${table_name} where v:h = 'string_2'"""
        // todo: support for delete predicate 
        // qt_sql_1_11 """delete from ${table_name} where v:a > 30000"""
        qt_sql_1_12 """select * from ${table_name} where v:a > 30000 order by k"""
