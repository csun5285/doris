...
suite("test_insert_into_lineitem_multiple_cluster") {
    def insert_table_base = "test_insert_into_lineitem_multiple_cluster"
    def stream_load_table_base = "test_stream_load_lineitem_multiple_cluster"
//    String[] clusters = new String[]{"hhb_cluster_name_0", "hhb_cluster_name_1", "hhb_cluster_name_2"}
    String[] clusters = new String[]{"hhb_cluster_name_0"}
    def index = 0;
...
PROPERTIES (
    ...
    def process_insert_into = { file_name, cluster_name, table_name ->
...
//            String cluster = clusters[(index++) % 3]
            String cluster = clusters[0]
            create_insert_table(table_name)
            logger.info("insert into file:" + file_name + ",table:" + table_name + ",cluster:" + cluster)
            threads.add(Thread.startDaemon {
                process_insert_into(file_name, cluster, table_name)
            })
        }
