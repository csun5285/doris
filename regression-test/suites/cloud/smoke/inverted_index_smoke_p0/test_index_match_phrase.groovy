...
suite("smoke_test_index_match_phrase_select", "smoke"){
    if (context.config.cloudVersion != null && !context.config.cloudVersion.isEmpty()
        ...
        log.info("case: smoke_test_index_match_phrase_select, cloud version ${context.config.cloudVersion} less than 3.0.0, skip".toString());
        return
    }
