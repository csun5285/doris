...
suite("test_alter_table_replace") {
    def tableNameA = "test_alter_table_replace_a"
    def tableNameB = "test_alter_table_replace_b"

    sql "DROP TABLE IF EXISTS ${tableNameA}"
    sql "DROP TABLE IF EXISTS ${tableNameB}"
    sql """
    ...
    sql """ INSERT INTO ${tableNameA} VALUES
    ...
    sql """ INSERT INTO ${tableNameB} VALUES
    ...
    qt_order """ select * from ${tableNameA} order by user_id"""
    qt_order """ select * from ${tableNameB} order by user_id"""

    sql """ALTER TABLE ${tableNameA} REPLACE WITH TABLE ${tableNameB} PROPERTIES('swap' = 'true');"""
