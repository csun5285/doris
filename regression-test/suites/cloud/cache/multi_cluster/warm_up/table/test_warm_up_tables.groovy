...
suite("test_warm_up_tables") {
    ...
    def jobId_ = sql "warm up cluster regression_cluster_name1 with table customer partition p1 and table customer partition p2;"
    ...
    clearFileCache.call(ipList[1], httpPortList[1]);
    jobId_ = sql "warm up cluster regression_cluster_name1 with table customer and table supplier;"
    waitJobDone(jobId_);
