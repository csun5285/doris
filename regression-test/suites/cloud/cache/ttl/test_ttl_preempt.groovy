...
// 1. clear file cache
// 2. load 19.5G normal table data into cache
// 3. check the cache metrics
// 4. select some data from normal table and check whether all data in cache or not
// 5. load 1.3G ttl table data into cache
        ...
        respCode, body ->
            ...
            for (String line in strs) {
                ...
                if (line.contains("file_cache_cache_size")) {
                    ...
                    def i = line.indexOf(' ')
                    assertTrue(total_cache_size < line.substring(i).toLong())
                    flag2 = true
                }
            }
            assertTrue(flag1 && flag2)
