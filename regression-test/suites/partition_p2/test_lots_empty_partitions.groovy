...
suite("test_lots_empty_partitions") {
    def tbName = "test_lots_empty_partitions"
    ...
    sql """ insert into ${tbName} values (100, false, 1, null, "c5", "2023-09-01", null, "c8", 1.1234, "c10");"""
    sql """ set disable_empty_partition_prune = true; """
    qt_sql """ select c1,c10 from ${tbName} order by c1 ASC;"""
    sql """ truncate table ${tbName};"""
    qt_sql """ select c1,c10 from ${tbName} order by c1 ASC;"""
    sql """ set disable_empty_partition_prune = false; """
}
