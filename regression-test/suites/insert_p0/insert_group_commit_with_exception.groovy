        ...
        try {
            ...
            try {
                ...
                /*if (item == "nereids") {
                    ...
                    assertTrue(e.getMessage().contains("Column count (3) doesn't match value count (4)"))
                //}
            }
            ...
            try {
                ...
                /*if (item == "nereids") {
                    ...
                    assertTrue(e.getMessage().contains("Column count (3) doesn't match value count (2)"))
                //}
            }
            ...
            try {
                ...
                /*if (item == "nereids") {
                    ...
                    assertTrue(e.getMessage().contains("Column count (2) doesn't match value count (3)"))
                //}
            }
            ...
            try {
                ...
                /*if (item == "nereids") {
                    ...
                    assertTrue(e.getMessage().contains("Column count (2) doesn't match value count (1)"))
                //}
            }
            ...
            try (Connection connection = DriverManager.getConnection(url, context.config.jdbcUser, context.config.jdbcPassword)) {
                ...
                try (PreparedStatement ps = connection.prepareStatement("insert into ${table} values(?, ?, ?)")) {
                    ...
                    try {
                        ...
                        assertTrue(e.getMessage().contains("Column count (4) doesn't match value count (3)"))
                    }
                }
                getRowCount(14)
