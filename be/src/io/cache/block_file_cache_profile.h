...
struct FileCacheProfileReporter {
    ...
    RuntimeProfile::Counter* inverted_index_wait_timer = nullptr;
    ...
    FileCacheProfileReporter(RuntimeProfile* profile) {
        ...
        inverted_index_wait_timer =
                ADD_CHILD_TIMER_WITH_LEVEL(profile, "InvertedIndexWaitTimer", cache_profile, 1);
    }
    ...
    void update(const FileCacheStatistics* statistics) const {
        ...
        COUNTER_UPDATE(inverted_index_wait_timer, statistics->inverted_index_wait_timer);
    }
};
