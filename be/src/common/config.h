...
DECLARE_Int32(async_remote_io_thread_pool_thread_num);
// number of s3 io thread pool queue size for async_io
DECLARE_Int32(async_remote_io_thread_pool_queue_size);

// number of local io thread pool size for async_io
DECLARE_Int32(async_local_io_thread_pool_thread_num);
...
DECLARE_mInt32(vacuum_stale_rowsets_interval_seconds);
DECLARE_mInt32(tablet_sync_interval_seconds);
DECLARE_mInt32(schedule_sync_tablets_interval_seconds);
...
DECLARE_Bool(enable_limit_optimize);
DECLARE_Bool(enable_scanner_early_cancel);
