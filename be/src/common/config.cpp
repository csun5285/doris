...
DEFINE_Int32(sys_warn_log_roll_num, "-1");
// verbose log
...
DEFINE_mBool(fuzzy_vertical_compaction, "false");
...
DEFINE_mInt64(flush_size_for_sparkload, "1073741824");
...
DEFINE_Int32(async_remote_io_thread_pool_thread_num, "48");
// number of s3 io thread pool queue size for async_io
DEFINE_Int32(async_remote_io_thread_pool_queue_size, "102400");

// number of local io thread pool size for async_io
DEFINE_Int32(async_local_io_thread_pool_thread_num, "48");
// number of local io thread pool queue size for async_io
DEFINE_Int32(async_local_io_thread_pool_queue_size, "102400");
...
DEFINE_Int32(multi_get_per_batch, "10");
...
// disable java udf
DEFINE_Bool(disable_java_udf, "true");
...
DEFINE_mInt32(check_enable_versioning_interval_seconds, "3600"); // 1 hours
...
DEFINE_mInt32(inverted_index_max_buffer_docs, "100000000");
// setMergeFactor for lucene
DEFINE_mInt32(inverted_index_merge_factor, "100000000");
...
DEFINE_Bool(enable_limit_optimize, "true");
DEFINE_Bool(enable_scanner_early_cancel, "true");
