...
#define INCR_COUNTER(Parent)                                                                    \
    ...
    COUNTER_UPDATE(Parent->_inverted_index_searcher_search_timer1,                              \
                   stats.inverted_index_searcher_search_timer1);                                \
    COUNTER_UPDATE(Parent->_inverted_index_searcher_search_timer2,                              \
                   stats.inverted_index_searcher_search_timer2);                                \
