...
const char* parse_binary_from_sparse_column(FieldType type, const char* data, Field& res,
    ...
    case FieldType::OLAP_FIELD_TYPE_ARRAY: {
        ...
        for (size_t i = 0; i < size; ++i) {
            ...
            const auto nested_type =
                    static_cast<const FieldType>(*reinterpret_cast<const uint8_t*>(data++));
    ...
    case FieldType::OLAP_FIELD_TYPE_IPV6: {
        res = reinterpret_cast<const PackedUInt128*>(data)->value;
...
std::pair<Field, FieldInfo> ColumnObject::deserialize_from_sparse_column(const ColumnString* value,
    ...
    const FieldType type = static_cast<const FieldType>(*reinterpret_cast<const uint8_t*>(data++));
    Field res;
    FieldInfo info_res = {
