...
void DorisFSDirectory::FSIndexInput::readInternal(uint8_t* b, const int32_t len) {
    ...
    int64_t inverted_index_wait_timer = 0;
    {
        ...
        inverted_index_wait_timer += sw.elapsed_time();
    ...
    if (_io_ctx.file_cache_stats != nullptr) {
        ...
        _io_ctx.file_cache_stats->inverted_index_wait_timer += inverted_index_wait_timer;
    }
}
