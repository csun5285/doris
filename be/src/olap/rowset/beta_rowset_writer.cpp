...
Status BetaRowsetWriter::expand_variant_to_subcolumns(vectorized::Block& block,
    ...
    // key: variant column pos
    // values: sparse columns within a variant column
    ...
    try {
        ...
        vectorized::schema_util::finalize_variant_columns(
                block, variant_column_pos, false /*not ingore sparse*/, &variant_sparse_subcolumns);
