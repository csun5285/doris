...
TEST_F(VariantColumnWriterReaderTest, test_compaction_nokey_variant_uid0) {
    ...
    TEST_F(VariantColumnWriterReaderTest, test_doc_mode_no_downgrade_hierarchical_read) {
        ...
        TabletSchemaPB schema_pb;
        schema_pb.set_keys_type(KeysType::DUP_KEYS);
        construct_column(schema_pb.add_column(), 1, "VARIANT", "V1", kMaxSubcolumns, false, false,
                         0, true,
                         /*variant_doc_materialization_min_rows=*/100000,
                         /*variant_doc_hash_shard_count=*/kDocBuckets);
        _tablet_schema = std::make_shared<TabletSchema>();
        ...
        {
            EXPECT_TRUE(variant_column_reader->get_subcolumn_meta_by_path(PathInData("a")) ==
                        nullptr)
        ...
        {
            EXPECT_TRUE(variant_column_reader->get_subcolumn_meta_by_path(
                                PathInData("nonexistent")) == nullptr);
