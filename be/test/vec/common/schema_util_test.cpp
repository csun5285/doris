...
TEST_F(SchemaUtilTest, TestIntegerConversion) {
    ...
    EXPECT_FALSE(variant_util::is_conversion_required_between_integers(
            PrimitiveType::TYPE_TINYINT, PrimitiveType::TYPE_SMALLINT));
    EXPECT_FALSE(variant_util::is_conversion_required_between_integers(PrimitiveType::TYPE_TINYINT,
                                                                       PrimitiveType::TYPE_INT));
    EXPECT_FALSE(variant_util::is_conversion_required_between_integers(PrimitiveType::TYPE_SMALLINT,
                                                                       PrimitiveType::TYPE_INT));

    EXPECT_TRUE(variant_util::is_conversion_required_between_integers(
            PrimitiveType::TYPE_INT, PrimitiveType::TYPE_SMALLINT));
    EXPECT_TRUE(variant_util::is_conversion_required_between_integers(PrimitiveType::TYPE_BIGINT,
                                                                      PrimitiveType::TYPE_INT));
    ...
    EXPECT_TRUE(variant_util::is_conversion_required_between_integers(PrimitiveType::TYPE_SMALLINT,
