...
static std::string_view print_cluster_status(const ::selectdb::ClusterStatus& status) {
    switch (status) {
...
void MetaServiceImpl::alter_cluster(google::protobuf::RpcController* controller,
    ...
    case AlterClusterRequest::UPDATE_CLUSTER_MYSQL_USER_NAME: {
        msg = resource_mgr_->update_cluster(
                ...
                [&](::selectdb::ClusterPB& c, std::set<std::string>&) {
    ...
    case AlterClusterRequest::SET_CLUSTER_STATUS: {
        msg = resource_mgr_->update_cluster(
                ...
                [&](::selectdb::ClusterPB& c, std::set<std::string>&) {
                    ...
                    // status from -> to
                    std::set<std::pair<selectdb::ClusterStatus, selectdb::ClusterStatus>>
