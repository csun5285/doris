...
public class SessionVariable implements Serializable, Writable {
    ...
    @VariableMgr.VarAttr(name = "topn_lazy_materialization_using_index", needForward = true, fuzzy = false, varType = VariableAnnotation.EXPERIMENTAL)
    ...
    @VariableMgr.VarAttr(name = ENABLE_LOCAL_EXCHANGE, fuzzy = false, flag = VariableMgr.INVISIBLE, varType = VariableAnnotation.DEPRECATED, needForward = true)
    ...
    @VariableMgr.VarAttr(name = IVF_NPROBE, needForward = true, description = { "IVF 索引的 nprobe 参数，控制搜索时访问的聚类数量",
