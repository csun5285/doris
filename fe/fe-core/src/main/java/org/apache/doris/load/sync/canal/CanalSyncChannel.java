...
public class CanalSyncChannel extends SyncChannel {
    ...
    public void beginTxn(long batchId) throws UserException, TException, TimeoutException,
        ...
        if (!isTxnBegin()) {
            ...
            int databaseRunningTxnNums = globalTransactionMgr.getRunningTxnNums(db.getId());
            if (databaseRunningTxnNums < Config.max_running_txn_num_per_db) {
