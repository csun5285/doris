...
public class CloudMetrics {
    ...
    protected static AutoMappedMetric<LongCounterMetric> CLUSTER_QUERY_INCOMING_COUNTER;
    ...
    protected static void init() {
        ...
        CLUSTER_QUERY_INCOMING_COUNTER = new AutoMappedMetric<>(name -> {
            LongCounterMetric counter  = new LongCounterMetric("query_incoming_total", MetricUnit.REQUESTS,
                    "total incoming query");
