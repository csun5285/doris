...
public class CreateUserStmtTest {
    ...
    public void testEmptyUser(@Injectable Analyzer analyzer, @Mocked Auth auth) throws UserException, AnalysisException {
        new Expectations() {
            {
                analyzer.getClusterName();
                result = "testCluster";
    ...
    @Test(expected = AnalysisException.class)
    public void testBadPass(@Injectable Analyzer analyzer, @Mocked Auth auth) throws UserException, AnalysisException {
        new Expectations() {
            {
                analyzer.getClusterName();
                result = "testCluster";
