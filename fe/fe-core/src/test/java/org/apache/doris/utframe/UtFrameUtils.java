...
public class UtFrameUtils {
    ...
    public static int startFEServer(String runningDir, int metaPort) throws EnvVarNotSetException, IOException,
        ...
        for (int i = 0; i <= 3; i++) {
            try {
                return startFEServerWithoutRetry(runningDir, metaPort);
    ...
    private static int startFEServerWithoutRetry(String runningDir, int metaPort) throws EnvVarNotSetException, IOException,
